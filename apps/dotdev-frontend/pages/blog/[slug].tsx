...
const MDX_CUSTOM_COMPONENTS = {
  ...
  blockquote: (props: any) => <div className="tw-pl-3 tw-border-l-2 tw-border-secondary tw-bg-stroke" {...props} />,
  ul: (props: any) => <ul className="tw-list-item tw-ml-7" {...props} />,
  ol: (props: any) => <ol className="tw-list-decimal tw-ml-7" {...props} />,
  li: (props: any) => <li {...props} />,
  pre: (props: any) => <pre className="tw-p-1 tw-border tw-border-secondary tw-rounded" {...props} />,
